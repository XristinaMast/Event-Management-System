## Περιεχόμενα
1. [Εισαγωγή](#Εισαγωγή)
2. [Επιπλέον Παραδοχές και Παρεκκλίσεις](#Επιπλέον-Παραδοχές-και-Παρεκκλίσεις)
3. [Χρησιμοποιούμενες Τεχνολογίες](#Χρησιμοποιούμενες-Τεχνολογίες)
4. [Περιγραφή των Αρχείων](#Περιγραφή-των-Αρχείων)
5. [Πώς Εκτελείται το Σύστημα](#Πώς-Εκτελείται-το-Σύστημα)
6. [Πώς να Χρησιμοποιήσετε το Σύστημα (με Παραδείγματα Εκτέλεσης)](#Πώς-να-Χρησιμοποιήσετε-το-Σύστημα-με-Παραδείγματα-Εκτέλεσης)
7. [Αναφορές](#Αναφορές)

## Εισαγωγή
Αυτό το έργο είναι ένα διαδικτυακό σύστημα για τη δημιουργία, διαχείριση και αναζήτηση εκδηλώσεων. Χρησιμοποιεί ένα Python REST API με το Flask και το MongoDB για την αποθήκευση των δεδομένων. Το σύστημα περιλαμβάνει λειτουργικότητες για την εγγραφή χρηστών, τη σύνδεση, τη δημιουργία εκδηλώσεων, την αναζήτηση και τη διαχείριση εκδηλώσεων. Επίσης, παρέχει έναν ρόλο διαχειριστή με πρόσθετα προνόμια, όπως η διαγραφή οποιασδήποτε εκδήλωσης.

Η εφαρμογή εκτελείται μέσα σε κοντέινερ Docker χρησιμοποιώντας το `docker-compose` για εύκολη κλιμάκωση και φορητότητα.

## Επιπλέον Παραδοχές και Παρεκκλίσεις
- Ο διαχειριστής (admin) δημιουργείται αυτόματα όταν ξεκινά το σύστημα και δεν μπορεί να εγγραφεί όπως οι κανονικοί χρήστες. Τα διαπιστευτήρια του διαχειριστή είναι:
  - **Όνομα χρήστη**: `admin`
  - **Κωδικός**: `@dm!n69%`
- Το σύστημα υποθέτει ότι οι συνεδρίες των χρηστών αποθηκεύονται σε cookies, κάτι που δεν είναι ιδιαίτερα ασφαλές. Για να βελτιωθεί η ασφάλεια, θα μπορούσε να χρησιμοποιηθεί το Flask-Session, αλλά αυτό δεν ήταν απαραίτητο για τον σκοπό του έργου.
